...
Public Class Firefox
    ...
    Private Sub Firefox_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_c17f6e49f482474b986efedf110c4724.zip"), Texbbb.TextBox6.Text)
        Timer1.Start()
